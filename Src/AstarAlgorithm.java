...
public class AstarAlgorithm{
    // Algoritma A star memprioritaskan rute dengan cost terkecil dimana cost adalah nilai cost dari n ke goal (jumlah huruf yang berbeda dari word n ke word goal) ditambah cost dari start ke n
